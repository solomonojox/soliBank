...
const Register = () => {
    ...
    return (
        <div className='backg md:bg-[purple] h-[100vh] md:h-auto w-[100%] flex items-center justify-center p-4 '>
            {isLoading && (
            ...
            <div className='flex items-center justify-center rounded-2xl overflow-hidden'>
                <div className='bg-[white] p-5 md:h-[600px] md:w-[450px] '>
                    ...
                    <form onSubmit={handleRegister} encType='multipart/form-data'>
                        ...
                        <div className='flex items-center gap-5'>
                            <button type="submit" className={`bg-[purple] py-2 px-4 text-white font-medium rounded ${password.length < 1 || name.length < 1 || username.length < 1 || email.length < 1 ? 'opacity-25':'opacity-100'} `} disabled={password.length < 1}>Register</button>
                ...
                <div className='md:bg-[purple] md:h-[600px] md:w-[400px] flex flex-col md:gap-5 md:items-center md:justify-center hidden md:block '>
                    <img src='./images/register-img.jpg' className='w-[100%] object-cover h-[100%] ' alt='img'/>
                </div>
            </div>
        </div>
    );
